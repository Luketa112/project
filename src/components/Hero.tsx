...
const Hero: React.FC = () => {
  return (
    <section id="home" className="bg-gradient-to-br from-black via-gray-900 to-black py-20">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="space-y-12">
          <a href="#products" className="cursor-pointer px-12 py-4  bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold text-xl rounded-lg hover:from-yellow-500 hover:to-yellow-700 transition-all duration-300 shadow-lg hover:shadow-yellow-500/25 transform hover:scale-105">
